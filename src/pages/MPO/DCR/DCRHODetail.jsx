...
import { useGetHODCRsByIdQuery, useGetHODCRHaruByIdQuery } from '../../../api/HighOrderSlices/hoDCRSlice';
...
import { useGetRewardsForHigherOrderByDcrIdQuery } from '../../../api/DCRs Api Slice/rewardsAPISlice';
import { useGetHigherOrderVisitedWithByDcrIdQuery } from '../../../api/MPOSlices/companyRolesSlice';
...
const RewardsRole = ({ id }) => {
    const { data } = useGetRewardsForHigherOrderByDcrIdQuery(id);
    return (
        <>
            {
                data !== undefined ?
...
const VisitedWith = ({ id }) => {
    const { data } = useGetHigherOrderVisitedWithByDcrIdQuery(id);
    return (
        <>
            {
                data !== undefined ?
...
export default React.memo(DCRHODetail);
