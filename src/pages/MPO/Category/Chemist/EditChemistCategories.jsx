...
const EditChemistCategories = ({ idharu, onClose }) => {


    //! Getting Category by ID
    const Category = useGetChemistsCategoryByIdQuery(idharu);
    ...
    useEffect(() => {
        if (Category.data) {
            setInitialFValues({
                category_name: Category?.data?.doctor_category.category_name.category_name,
            });
        }
    }, [Category.data])
    ...
    //! Edit tourplan
    const [updateCategory] = useUpdateChemistsCategoryMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage({ show: true, message: 'Successfully Edited Category Name' });
            setTimeout(() => {
                history("/dashboard/admin/doctorcategory")
...
export default EditChemistCategories;