...
const EditSecondarySales = ({ idharu, onClose, selectedOption, monthData, selectedYear }) => {
    ...
    const SecondarySales = useGetSecondarySalesByIdQuery(idharu);
    ...
    useEffect(() => {
        if (SecondarySales.data) {
            setInitialFValues({
                'product': SecondarySales?.data?.product,
                'opening_stock': SecondarySales?.data?.opening_stock,
                'closing_stock': SecondarySales?.data?.closing_stock,
                'purchase': SecondarySales?.data?.purchase,
                'sales_return': SecondarySales?.data?.sales_return,
                'sales': SecondarySales?.data?.sales,
                'total': SecondarySales?.data?.total,
                'free': SecondarySales?.data?.free,
                'exchange_breakage': SecondarySales?.data?.exchange_breakage,
                'l_rate': SecondarySales?.data?.l_rate,
                'st_value': SecondarySales?.data?.st_value,
                'sl_value': SecondarySales?.data?.sl_value,
            });
        }
    }, [SecondarySales.data])
    ...
    //! Edit user
    const [updateSecondarySaless] = useUpdateSecondarySalesMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await updateSecondarySaless(formData).unwrap();
