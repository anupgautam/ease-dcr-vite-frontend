                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="ud-widget">
                                    <a href="index.html" style={{ display: "flex" }} className="ud-footer-logo">
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <p className="ud-footer-bottom-right" style={{ marginRight: "6px" }}>
                                    Designed and Developed by
                                    <a href="https://thinkfortech.com/" rel="nofollow" style={{ marginLeft: '4px', color: 'white', fontWeight: "600" }}>Think 4 Tech</a>
                                </p>
                            </div>
                        </div>
                    </div>
