...
const Scrollnav = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 h-16 lg:h-20 bg-white transition-transform duration-300 content-center ease-in-out z-50 drop-shadow-md ${
    ...
    <div className=" flex gap-x-2 lg:gap-x-7 font-bold">
    {
      navItems.map((item,idx)=>{
        return(
          <Link to={item.path} smooth={true} spy={true} offset={-100} duration={800} key={idx} activeClass="active-link">
