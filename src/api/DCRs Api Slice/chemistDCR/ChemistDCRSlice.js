    ...
    endpoints: builder => ({
        ...
        searchChemistsDCR: builder.query({
            query: (searchChemistsDCR) => {
                ...
                return {
                    url: `dcr/mpo-shift-wise-dcr-for-chemist/?dcr__dcr__visited_chemist__company_name=${searchChemistsDCR.company_name}&mpo_name=${searchChemistsDCR.user_id}&dcr__dcr__month=${searchChemistsDCR.month}&dcr__dcr__date=${searchChemistsDCR.date}`,
                    method: 'GET',
                }
            },
            providesTags: ['ChemistDCR']
